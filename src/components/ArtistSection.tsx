      ...
      <div className="max-w-[1875px] mx-auto">
        <div className="flex flex-col lg:flex-row gap-10">
          <div className="lg:w-[200px] shrink-0">
            <h2 className="text-[#323232] text-[19.7px] font-bold leading-5 tracking-[-0.202px] uppercase max-sm:text-base max-sm:leading-[18px]">
              The Artist
            </h2>
          </div>
          ...
          <div className="flex-1">
            <div className="mb-10">
              <h3 className="text-[#323232] text-[39.4px] font-bold leading-[45px] tracking-[-0.607px] uppercase max-md:text-[28px] max-md:leading-8 max-sm:text-xl max-sm:leading-6">
            ...
            <div className="flex flex-col lg:flex-row gap-10">
              ...
              <div className="lg:w-[377px]">
                <div className="mb-5">
                  <p className="text-[#888] text-[17.4px] font-bold leading-[19.8px] tracking-[-0.027px] max-sm:text-sm max-sm:leading-4">
