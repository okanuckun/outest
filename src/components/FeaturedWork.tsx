  ...
  return (
    <section className="box-border flex w-full flex-col items-start gap-[31.5px] relative bg-white m-0 px-[22.5px] py-[80px] max-md:px-5 max-md:py-10 max-sm:px-4 max-sm:py-6">
      <div className="box-border flex flex-col items-start gap-[72px] self-stretch relative m-0">
        ...
        <div className="box-border flex justify-center items-start gap-4 self-stretch relative m-0 p-0 max-md:flex-col max-md:gap-5">
          <article className="box-border flex flex-col items-start flex-[1_0_0] self-stretch relative m-0 p-0">
            <div className="box-border flex flex-col justify-center items-start self-stretch aspect-[614.33/767.91] relative m-0 p-0">
              <img
