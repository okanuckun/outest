...
const FeaturedWork: React.FC = () => {
  const works = [{
    src: "https://images.unsplash.com/photo-1611501275019-9b5cda994e8d?w=800&h=1000&fit=crop",
    alt: "Featured tattoo work 1"
  }, {
    src: "https://images.unsplash.com/photo-1590246814883-57764ecdadef?w=800&h=1000&fit=crop",
    alt: "Featured tattoo work 2"
  }, {
    src: "https://images.unsplash.com/photo-1598371839696-5c5bb00bdc28?w=800&h=1000&fit=crop",
    alt: "Featured tattoo work 3"
  }];
  return <section className="box-border flex w-full flex-col items-start gap-[31.5px] relative bg-white m-0 px-[22.5px] py-[80px] max-md:px-5 max-md:py-10 max-sm:px-4 max-sm:py-6">
      <div className="box-border flex flex-col items-start gap-[72px] self-stretch relative m-0">
        ...
        <StaggerChildren staggerDelay={0.15} className="box-border flex justify-center items-start gap-4 self-stretch relative m-0 p-0 max-md:flex-col max-md:gap-5">
          {works.map((work, index) => <StaggerItem key={index} className="box-border flex flex-col items-start flex-[1_0_0] self-stretch relative m-0 p-0">
            ...
            duration: 0.3
                ...
                <motion.img src={work.src} alt={work.alt} className="box-border w-full h-full relative object-cover m-0 p-0" whileHover={{
              scale: 1.1
            }} transition={{
              duration: 0.5
            }} />
