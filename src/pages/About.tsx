  ...
  return (
    ...
    >
      ...
      <header className="box-border flex h-[60px] flex-col items-start shrink-0 self-stretch relative z-10 m-0 p-0">
        <nav className="box-border flex flex-col items-start self-stretch relative m-0 px-[22.5px] py-[18px] border-b-[#323232] border-b border-solid max-sm:px-4 max-sm:py-4">
      ...
      <div className="flex">
        {/* Left grid line */}
        <div className="hidden lg:block w-[22.5px] border-r border-[#EAEAEA]" />
        
        {/* Content */}
        <div className="flex-1">
          {/* Hero Section */}
          <section className="box-border w-full px-[22.5px] pt-[80px] pb-0 max-md:px-5 max-sm:px-4 max-sm:pt-10 lg:px-0 lg:pr-[22.5px]">
            <ScrollReveal>
          ...
          {/* Divider */}
          <div className="w-full h-px bg-[#EAEAEA] mt-[40px]" />
          ...
          {/* Divider with label */}
          <div className="w-full border-t border-[#323232]">
            <div className="px-[22.5px] py-3 max-sm:px-4">
              <span className="text-[#888] text-[11px] font-normal tracking-[0.3px] uppercase">
                My Story
              </span>
            </div>
          </div>
          ...
          {/* My Story Section */}
          <section className="box-border w-full px-[22.5px] py-[100px] max-md:px-5 max-md:py-[60px] max-sm:px-4 max-sm:py-[40px] lg:px-0 lg:pr-[22.5px] border-b border-[#EAEAEA]">
          ...
          <div className="w-full">
            <div className="flex flex-col lg:flex-row">
              <ScrollReveal className="flex-1">
                <div className="h-[700px] overflow-hidden max-md:h-[450px] max-sm:h-[300px] border-r border-[#EAEAEA] max-lg:border-r-0 max-lg:border-b">
                  <motion.img 
                    src={aboutImage2} 
        ...
        {/* Right grid line */}
        <div className="hidden lg:block w-px bg-[#323232]" />
        <div className="hidden lg:block w-[120px] border-l border-[#EAEAEA]" />
      </div>
